...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes, block, layers, evaluate=False,ignore_class=False,merge_class=False,dataset=None):
        if ignore_class:
            num_classes -= 1
...
class Double_ResNet(nn.Module):
    ...
    def __init__(self, num_classes, block, layers, color_mode, fusion_type, step, evaluate = False, ignore_class=False, merge_class=False, dataset=None):
