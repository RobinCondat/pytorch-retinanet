...
class GFU(nn.Module):
    def __init__(self,out_channels):
        ...
        """
        self.reduce_RGB = nn.Conv2d(self.input_channels,self.input_channels//2,kernel_size=1,padding=0)

        self.reduce_DOL = nn.Conv2d(self.input_channels,self.input_channels//2,kernel_size=1, padding=0)
        ...
        self.conv_MIX = nn.Conv2d(2*self.input_channels,self.out_channels,kernel_size=1)
    ...
    def forward(self,x_RGB,x_DOL):
        ...
        """
        x_RGB = self.reduce_RGB(x_RGB)
        x_DOL = self.reduce_DOL(x_DOL)
